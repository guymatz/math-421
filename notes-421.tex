...
\section*{Theorems \& Notes}%
  ...
  \thm{ 2 } {
    ...
    $N \in \mathbb{Z} $ for all $x \in [a,b]$.  That is, $f$ is
    bounded above.
  }

  \thm{ 3 } {
    If $f$ is continuous on $[a,b]$ then there exists a $y \in [a,b]$
    such that $f(x) \leq f(y), \forall x \in [a,b]$
  }
  ...
  \thm{ LUB / GLB existence } {
    If $A  \subset  \mathbb{R}$ $A \neq \emptyset$ and $A$ has a lower
    bound, then A has a GLB.
  }
